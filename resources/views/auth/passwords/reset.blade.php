...
@section('content')
    <div class="container col-md-6">
        ...
        <div class="appointment-wrap bg-white p-5 d-flex align-items-center" style="margin-top: 100px">
            ...
            <form class="appointment-form ftco-animate" method="POST" action="{{ route('password.update') }}">
                @csrf
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-secondary py-3 px-4"> {{ __('Reset Password') }}</button>
                </div>
