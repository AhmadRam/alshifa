        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-4">
                    <h1 class="mb-3 bread" style="padding-bottom: 285px;text-align: center">{{ $hotel->name }}</h1>
                    ...
                    <div class="appointment-wrap bg-white p-5 d-flex align-items-center">
                        ...
                        <div id="carouselExampleControls" class="col-md-4 carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                @if(is_array(json_decode($hotel->photo)))
                                @foreach (json_decode($hotel->photo) as $key => $photo)
